...
print("Variance expliquée cumulée par les composantes principales :")
...
print("Colonnes non numériques :", colonnes_non_numeriques)
...
# Pour le modèle avant suréchantillonnage
print(f"Accuracy avant suréchantillonnage : {accuracy_before:.2f}")
print("Rapport de classification avant suréchantillonnage :")
print(classification_report(y_test, y_pred_before))

# Pour le modèle après suréchantillonnage
accuracy_after = accuracy_score(y_test, y_pred)
print(f"Accuracy après suréchantillonnage : {accuracy_after:.2f}")
print("Rapport de classification après suréchantillonnage :")
print(classification_report(y_test, y_pred))
...
Classe "Élevé" : Recall 95%, F1-score 94%
Observation : Le modèle semble bien fonctionner, mais il favorise peut-être les classes majoritaires.

Après suréchantillonnage :
Accuracy : 81% (baisse de 9%)
Classe "Bas" : Recall 91% (+4%), F1-score 83%
Classe "Moyen" : Recall 66% (-17%), F1-score 73%
Classe "Élevé" : Recall 89% (-6%), F1-score 88%
Observation :
Le modèle est plus équilibré entre les classes.
Il est meilleur pour la classe "Bas" (meilleur recall).
Il a plus de difficulté avec la classe "Moyen" (baisse du recall).
"""
